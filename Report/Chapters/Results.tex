...
%	Can a cell or pathway still function without this protein? or is there an alternative mechanism within the cell that is less efficient in performing similar role? 
	...
	\begin{figure}[!ht]
		\centering
		\begin{subfigure}{0.45\textwidth}
			\includegraphics[width=\textwidth,height=0.2\textheight]{Relax_Pymol_Images/TNFA_wild.png}{a}
			\phantomcaption
			\label{fig:RES_TNFA_wild}
		\end{subfigure}
		\begin{subfigure}{0.45\textwidth}
			\includegraphics[width=\textwidth,height=0.2\textheight]{Relax_Pymol_Images/TNFA_18.png}{b}
			\phantomcaption
			\label{fig:RES_TNFA_18}
		\end{subfigure}
		\begin{subfigure}{0.45\textwidth}
			\includegraphics[width=\textwidth,height=0.2\textheight]{Relax_Pymol_Images/TNFA_94.png}{c}
			\phantomcaption
			\label{fig:RES_TNFA_94}
		\end{subfigure}
		\begin{subfigure}{0.45\textwidth}
			\includegraphics[width=\textwidth,height=0.2\textheight]{Relax_Pymol_Images/TNFA_97.png}{d}
			\phantomcaption
		...
		\centering
		\begin{subfigure}{0.45\textwidth}
			\includegraphics[width=\textwidth]{Relax_Pymol_Images/TNFB_wild.png}{a}
			\phantomcaption
			\label{fig:RES_TNFB_wild}
		\end{subfigure}
		\begin{subfigure}{0.45\textwidth}
			\includegraphics[width=\textwidth]{Relax_Pymol_Images/TNFB_18.png}{b}
			\phantomcaption
			\label{fig:RES_TNFB_18}
		\end{subfigure}
		\begin{subfigure}{0.45\textwidth}
			\includegraphics[width=\textwidth]{Relax_Pymol_Images/TNFB_94.png}{c}
			\phantomcaption
			\label{fig:RES_TNFB_94}
		\end{subfigure}
		\begin{subfigure}{0.45\textwidth}
			\includegraphics[width=\textwidth]{Relax_Pymol_Images/TNFB_97.png}{d}
			\phantomcaption
