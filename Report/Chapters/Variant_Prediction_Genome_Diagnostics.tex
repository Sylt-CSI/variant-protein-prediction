...
another strategy is more commonly used called homology modeling.
%
%is a difficult task and currently relies on information of known structures. A technique that is used 
%
%With this method mainly two strategies are used that both rely on already known structures and the primary structure of the desired protein. 
%
%Homology modeling relies   
%
%An alternative method for generating protein structures than experimental methods is by solving the structures computationally through modeling of the primary structure. 
%It is cheaper but also has the downside of being less accurate than a crystal structure.
%which has the advantage of being cheaper b
%
%
%
%Protein modeling is a cheaper alternative for generating multiple structures
%A cheaper alternative for generating multiple structures than experimental determination of structures is modeling of proteins based on an amino acid sequence and previous determine protein structures.
%A cheaper method for generating protein structures than experimental determination is protein modeling. With this method proteins are made based on the primary structure of the desired protein and put together from folds or structure of previous known 
%
%
