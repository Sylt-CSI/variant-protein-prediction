...
For the aspect of machine learning this is mandatory to avoid overfitting, however any form of context that determines how a protein functions is removed and the lacks context on how it would function within the environment it resides and even which other residues it functions (*****talk about metals and water). (ii) 
