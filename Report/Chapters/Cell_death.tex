...
%On the surface dimers in parallel and anti-parelell diretion form at random when no tumor necrosis factor (TNF) $\alpha$ or $\beta$ is bound. surface the residues form dimers which can be in parallel or anti-parallel form 
%
%
