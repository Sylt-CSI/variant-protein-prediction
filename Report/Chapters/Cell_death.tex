...
External signaling molecules are able to initiate apoptosis or the extrinsic pathway, with two pathways, which fall under the name extrinsic pathway. One pathway that can be activated is by binding of a Fas ligand to a Fas receptor which will recruit several Fas associated death domain protein (FADD) and start to assemble the death-inducing signaling complex (DISC)
