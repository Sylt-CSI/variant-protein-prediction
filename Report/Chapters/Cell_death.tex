...
Tumor Necrosis Factor Receptor Super Family Member 1A (TNFRSF1A, TNFR1) is a cell membrane receptor consisting of 445 residues divided into a 171 extracellular and a 221 residue cytoplasmic section \cite{}.
...
When the structures are parallel dimers the binding sites are exposed and make it possible for tumor necrosis factor (TNF) (Section \ref{subsec:CD_TNF_A_B}) to bind in trimeric form, with binding of TNF the dimers disconnect and three separate TNFR1s connect to TNF trimer \cite{}.
%Crystallographic Evidence for Dimerization of Unliganded Tumor Necrosis Factor Receptor, Naismith
...
The proteins TNF $\alpha$ and $\beta$ share have several similarities; they are both cytokines and play a role in the 

The proteins TNF $\alpha$ and $\beta$ both: are cytokines, originate from monocytes, bind to TNFR1 and TNFR2 and form homotrimeric structure, they are also 35\% identical and are 50\% homologous to each other \cite{}. 
