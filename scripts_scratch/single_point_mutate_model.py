...
#
#  single_point_mutate_model.py
#
#     Usage:   python single_point_mutate_model.py modelname respos resname chain > logfile
#
#     Example: python single_point_mutate_model.py 1t29 1699 LEU A > 1t29.log
#
#
